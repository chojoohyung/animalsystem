...
public class AnimalUpdateView extends JPanel {
	...
	public void tableCellCenter(JTable t) {
		...
		dtcr.setHorizontalAlignment(SwingConstants.CENTER); // 렌더러의 가로정렬을 가운데로
	...
	public AnimalVO neededUpdateData() {
